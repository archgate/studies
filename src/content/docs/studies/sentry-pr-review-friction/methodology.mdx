...
Comments are classified using a keyword-based theme dictionary ([`theme_dictionary.json`](https://github.com/archgate/studies/blob/main/studies/sentry-pr-review-friction/theme_dictionary.json)). This is a deterministic, auditable approach:
